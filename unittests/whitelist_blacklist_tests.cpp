...
BOOST_AUTO_TEST_CASE( actor_blacklist_inline_deferred ) { try {
   ...
   auth.accounts.push_back( permission_level_weight{{"alice"_n, config::sikaio_code_name}, 1} );
   ...
   auth.accounts.push_back( permission_level_weight{{"alice"_n, config::sikaio_code_name}, 1} );
   auth.accounts.push_back( permission_level_weight{{"bob"_n, config::sikaio_code_name}, 1} );
   ...
   auth.accounts.push_back( permission_level_weight{{"charlie"_n, config::sikaio_code_name}, 1} );
