...
// Protocol layer (was eosio): genesis producer, native handlers, sikaio.null / sikaio.prods.
const static name protocol_account_name  { "sikaio"_n };
// Application system contract host (sika.system) and governance actions — not the protocol account.
const static name system_account_name    { "sika"_n };
const static name null_account_name      { "sikaio.null"_n };
const static name producers_account_name { "sikaio.prods"_n };
const static name default_token_contract_name { "sika.token"_n };
...
const static name sikaio_auth_scope      { "sikaio.auth"_n };
const static name sikaio_all_scope       { "sikaio.all"_n };

const static name active_name      { "active"_n };
const static name owner_name       { "owner"_n };
const static name sikaio_any_name  { "sikaio.any"_n };
const static name sikaio_code_name { "sikaio.code"_n };
